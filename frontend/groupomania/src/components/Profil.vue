...
export default {
  ...
  methods: {
    ...
    getOneUser() {
      ...
      axios
        .get(`http://localhost:3000/api/auth/user/${id_user}`, {
          headers: {
...
.profil_container {
  ...
  border-radius: 10px;
  padding: 1px;
  box-shadow: 6px 6px 6px rgba(0, 0, 0, 0.39),
    -0.4em 0 0.4em rgba(0, 0, 0, 0.39);
}
.info_profil {
  font-size: 25px;
  color: lightgrey;
...
.btn_suppresion:hover {
  box-shadow: 6px 6px 6px rgba(0, 0, 0, 0.534),
    -0.4em 0 0.4em rgba(0, 0, 0, 0.534);
  font-size: 23px;
}
