<template>
  <div>
      ...
      <p><button class="redirection_create"><a href="/publication">Créer une publication</a></button></p>
      <p><button class="redirection_profil"><a href="/affichagePublication/profil/:id">Acceder a votre profil</a></button></p>
...
.redirection_create, .redirection_profil {
    margin-bottom: 20px;
    padding: 10px;
...
.redirection_create:hover, .redirection_profil:hover {
...
.publication:hover {
    box-shadow: 6px 6px 6px rgba(0, 0, 0, 0.664), -0.4em 0 0.4em rgba(0, 0, 0, 0.664);
}
.info {
    color: lightgrey;
    font-size: 22px;
